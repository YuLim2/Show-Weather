...
@app.route("/")
def home():
    return render_template('index.html', subject="안녕하세요. 반갑습니다. 킹유림입니다")
...
@app.route("/show1")
def show1():
    return render_template('img_test1.html', image_file='static/img/1.jpeg')
 
#3 이미지2 - 크리스마스 카드 for 쌤
@app.route("/show2")
def show2():
    return render_template('img_test2.html', image_file='static/img/2.jpeg')
